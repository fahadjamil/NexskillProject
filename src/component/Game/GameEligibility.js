      ...
      <div className="row">
        <div className="col-md-6">
          ...
          <p className="pt-2 pl-3 pr-3 mt-4 description-text">
            <ul>
              <li>&nbsp;Anyone can understand English language.</li>
              <li>&nbsp;Anyone who can operate computer easily.</li>
              <li>&nbsp;Age Limit (16 Years minimum).</li>
            </ul>
          </p>
        </div>
        <div className="col-md-6">
...
export default GameEligibility;
