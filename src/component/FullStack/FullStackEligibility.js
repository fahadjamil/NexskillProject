...
import "./FullStackEligibility.css";

const FullStackEligibility = () => {
  return (
      ...
      <div className="row">
        <div className="col-md-6">
          ...
          <p className="pt-2 pl-3 pr-3 mt-4 description-text">
            <ul>
              <li>
                &nbsp;Students who do not have any programming experience or
                knowledge can attend this course.
              </li>
            </ul>
          </p>
        </div>
...
export default FullStackEligibility;
