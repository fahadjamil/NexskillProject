...
import './AmazonEligibility.css';

const AmazonEligibility=()=>{
    return (
          ...
          <div className="row">
            <div className="col-md-6">
              ...
              <p className="pt-2 pl-3 pr-3 mt-4 description-text">
                <ul>
                  <li>
                  &nbsp;Anyone with a basic knowledge of computer, who can understand English language can join this course. 
                  </li>
...
export default AmazonEligibility;