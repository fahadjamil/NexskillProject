...
import './YoutubeEligibility.css';

const YoutubeEligibility=()=>{
    return (
          ...
          <div className="row">
            <div className="col-md-6">
              ...
              <p className="pt-2 pl-3 pr-3 mt-4 description-text">
                <ul>
                  <li>
                  &nbsp;Anyone who wishes to learn how to start their own YouTube channel. 
                  </li>
...
export default YoutubeEligibility;